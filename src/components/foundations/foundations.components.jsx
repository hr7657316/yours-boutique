        ...
        <>
            ...
            <div className="foundations-container">
                <div className="foundations-text-container">
                    <h2>Foundations</h2>
                    <p>
                        We at <span>Your Boutique</span> 
                        Welcome to 'Your Boutique,
                        ' where style is elevated and individuality celebrated. 
                        Explore our curated collection of fashion-forward clothing and accessories, designed to empower you to express yourself with confidence
                      .
                    </p>
                    <p>
